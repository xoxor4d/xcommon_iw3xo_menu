...
del xcommon_iw3xo_menu.ff

@echo.
@echo -------------- Cleaning raw/ui_iw3xo ------------------
@echo off
del /s /q "..\..\raw\ui_iw3xo\*" 
...
echo.
xcopy ui_iw3xo ..\..\raw\ui_iw3xo /SY
echo.
...
echo.
xcopy xcommon_iw3xo_menu.csv ..\..\zone_source /SY

@echo off
echo.
echo --------------- Building fastfiles --------------------
cd ..\..\bin
linker_pc.exe -language english -compress -cleanup xcommon_iw3xo_menu
...
echo.
echo ----------------- Copy fastfiles ----------------------
copy ..\..\zone\english\xcommon_iw3xo_menu.ff
